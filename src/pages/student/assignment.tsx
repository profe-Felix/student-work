...
export default function StudentAssignment(){
  const [pdfUrl] = useState<string>(`${import.meta.env.BASE_URL || '/' }aprende-m2.pdf`) // replace with assignment PDF
    ...
    <div style={{ padding: 12, paddingBottom: 120 }}><h2>Student Assignment (Hosted)</h2>
      ...
      >
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 10, pointerEvents: handMode ? 'none' : 'auto' }}>
          <DrawCanvas width={canvasSize.w} height={canvasSize.h} color={color} size={size} onStroke={onStroke} disabled={handMode} />
        </div>
      </div>
